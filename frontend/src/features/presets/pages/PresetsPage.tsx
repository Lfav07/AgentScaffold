...
export default function PresetsPage() {
    ...
    const sorted = useMemo(
        () => presetsList.data ? [...presetsList.data].sort((a, b) => a.name.localeCompare(b.name)) : [],
        [presetsList.data]
    );
    ...
    return (
        <div className="app-page">
            ...
            <main className="min-h-screen">
                {presetsList.isPending ? (
                    <LoadingView message={"Loading presets..."} />
                ) : presetsList.error ? (
                    <ErrorView message={"Could not load presets. Please try again."} />
                ) : (
