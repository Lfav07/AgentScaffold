...
export default function Hero() {
  ...
  return (
    <section className="relative flex flex-col items-center gap-6 overflow-hidden px-4 py-24 sm:py-32 bg-gradient-to-r from-white to-[#abbaab] dark:from-[#0a0a0f] dark:to-[#1a2e2e]">
