export default function ProductPreview() {
    return (
        <section className="mx-auto max-w-5xl px-4 py-20 sm:py-28">
            ...
            <div className="rounded-2xl border border-[var(--accent-border)] bg-[var(--bg)] shadow-lg shadow-[var(--accent)]/10">
                {/* Terminal header */}
                <div className="flex items-center gap-2 rounded-t-2xl border-b border-[var(--accent-border)] bg-[var(--accent)]/5 px-5 py-3">
